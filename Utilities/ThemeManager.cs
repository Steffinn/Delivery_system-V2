...
namespace MissionPlanner.Utilities
{
    ...
    public class ThemeColorTable
    {
        ...
        public void InitColors()
        {
            ...
            strThemeName = "DeliverySystem.mpsystheme";

            colors.Add("Background", Color.FromArgb(0x1C, 0x24, 0x31), "BGColor");						// This changes the colour of the main menu background
            colors.Add("Control Background", Color.FromArgb(0x2E, 0x3A, 0x4A), "ControlBGColor");		// This changes the colour of the sub menu backgrounds
            colors.Add("Text", Color.White, "TextColor");										// This changes the colour of text
            colors.Add("TextBox Background", Color.FromArgb(0x2E, 0x3A, 0x4A), "BGColorTextBox");		// This changes the colour of the background of textboxes
            colors.Add("Button Text", Color.FromArgb(0x4A, 0x2E, 0x00), "ButtonTextColor");				// This changes the colour of button text
            colors.Add("Button Background top", Color.FromArgb(0xFF, 0x8A, 0x00), "ButBG");								// This changes the colour of button backgrounds (Top)
            colors.Add("Button Background bottom", Color.FromArgb(0xFF, 0xC4, 0x6B), "ButBGBot");						// This changes the colour of button backgrounds (Bot)
            colors.Add("ProgressBar Top", Color.FromArgb(0xCC, 0x6E, 0x00), "ProgressBarColorTop");	// These three variables change the colours of progress bars
            colors.Add("ProgressBar Bottom", Color.FromArgb(0xE8, 0x8A, 0x1F), "ProgressBarColorBot");
            colors.Add("ProgressBar Outline", Color.FromArgb(0xFF, 0xB8, 0x77), "ProgressBarOutlineColor");
            colors.Add("BannerColor1", Color.FromArgb(0x14, 0x20, 0x33), "BannerColor1");			// These two variables change the colours of banners such as "planner" umder configuration
            colors.Add("BannerColor2", Color.FromArgb(0xFF, 0x8A, 0x00), "BannerColor2");
            colors.Add("Disabled Button", Color.FromArgb(150, 0x33, 0x22, 0x00), "ColorNotEnabled");		// This changes the background color of buttons when not enabled
            colors.Add("Button Mouseover", Color.FromArgb(73, 0x33, 0x22, 0x00), "ColorMouseOver");			// This changes the background color of buttons when the mouse is hovering over a button
            colors.Add("Button Mousedown", Color.FromArgb(73, 0x33, 0x22, 0x00), "ColorMouseDown");			// This changes the background color of buttons when the mouse is clicked down on a button
            ...
            colors.Add("Graph Chart Fill", Color.FromArgb(0x12, 0x18, 0x1F), "ZedGraphChartFill"); 	// These three variables change the fill colours of Zed Graphs
            colors.Add("Graph Pane Fill", Color.FromArgb(0x23, 0x2C, 0x38), "ZedGraphPaneFill");
            colors.Add("Graph Legend Fill", Color.FromArgb(0x7C, 0x8B, 0x99), "ZedGraphLegendFill");
            ...
            colors.Add("Horizontal ProgressBar", Color.FromArgb(0xFF, 0x8A, 0x00), "HorizontalPBValueColor"); // This changes the colour of the horizontal progressbar
            colors.Add("HUD text and drawings", Color.LightGray, "HudText");
            colors.Add("HUD Ground top", Color.FromArgb(0xC8, 0x80, 0x2A), "HudGroundTop");
            colors.Add("HUD Ground bottom", Color.FromArgb(0x4A, 0x30, 0x10), "HudGroundBot");
