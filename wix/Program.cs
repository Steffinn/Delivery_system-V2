...
namespace wix
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string outputfilename = "DeliverySystem";

            if (args.Length > 1)
                outputfilename = args[1];

            string exepath = Path.GetFullPath(path) + Path.DirectorySeparatorChar + "DeliverySystem.exe";
            ...
            sw.WriteLine("    <Directory Id=\"INSTALLDIR\" Name=\"Delivery System\">");
            ...
            st.WriteLine(@"c:\cygwin\bin\rsync.exe -Pv -e '/usr/bin/ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i /cygdrive/c/Users/michael/sitl' " + fn + ".zip michael@mega2.ardupilot.org:DeliverySystem/");
            st.WriteLine(@"c:\cygwin\bin\rsync.exe -Pv -e '/usr/bin/ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i /cygdrive/c/Users/michael/sitl' " + fn + ".msi michael@mega2.ardupilot.org:DeliverySystem/");

            st.WriteLine(@"c:\cygwin\bin\rsync.exe -Pv -e '/usr/bin/ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i /cygdrive/c/Users/michael/sitl'   -l DeliverySystem-latest.zip michael@mega2.ardupilot.org:DeliverySystem/");
            st.WriteLine(@"c:\cygwin\bin\rsync.exe -Pv -e '/usr/bin/ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i /cygdrive/c/Users/michael/sitl'   -l DeliverySystem-latest.msi michael@mega2.ardupilot.org:DeliverySystem/");
...
<Wix xmlns=""http://schemas.microsoft.com/wix/2006/wi"" xmlns:netfx=""http://schemas.microsoft.com/wix/NetFxExtension"" xmlns:difx=""http://schemas.microsoft.com/wix/DifxAppExtension"" xmlns:iis='http://schemas.microsoft.com/wix/IIsExtension' >
    ...
    <Product Id=""" + newid + @""" Name=""Delivery System"" Language=""1033"" Version=""" + version + @""" Manufacturer=""Michael Oborne"" UpgradeCode=""{625389D7-EB3C-4d77-A5F6-A285CF99437D}"">

    <Package Description=""Delivery System Installer"" Comments=""Delivery System Installer"" Manufacturer=""Michael Oborne"" InstallerVersion=""200"" Compressed=""yes"" />
    ...
    <Directory Id=""TARGETDIR"" Name=""SourceDir"">
        ...
        <Directory Id=""ProgramMenuFolder"">
            <Directory Id=""ApplicationProgramsFolder"" Name=""Delivery System"" />
        </Directory>
    </Directory>
    ...
    <DirectoryRef Id=""ApplicationProgramsFolder"">
        <Component Id=""ApplicationShortcut"" Guid=""*"">
            <Shortcut Id=""ApplicationStartMenuShortcut10"" Name=""Delivery System"" Description=""Delivery System"" Target=""[INSTALLDIR]DeliverySystem.exe"" WorkingDirectory=""INSTALLDIR"" />
            <Shortcut Id=""UninstallProduct"" Name=""Uninstall Delivery System"" Description=""Uninstalls My Application"" Target=""[System64Folder]msiexec.exe"" Arguments=""/x [ProductCode]"" />
            <RegistryValue Root=""HKCU"" Key=""Software\MichaelOborne\DeliverySystem"" Name=""installed"" Type=""integer"" Value=""1"" KeyPath=""yes"" />
    ...
    <Feature Id=""Complete"" Title=""Delivery System"" Level=""1"">
...
";
    ...
    <Property Id=""WIXUI_EXITDIALOGOPTIONALCHECKBOXTEXT"" Value=""Launch Delivery System"" />
    ...
    <CustomAction Id=""LaunchApplication"" 
        ...
        static void dodirectory(string path, int level = 1)
        {
            ...
            foreach (string filepath in files)
            {
                ...
                if (filepath.EndsWith("DeliverySystem.exe"))
                {
                    mainexeid = "_" + no;

                    sw.WriteLine(tabs3 + "<File Id=\"" + mainexeid + "\" Source=\"" + filepath + "\" ><netfx:NativeImage Id=\"ngen_DeliverySystemexe\"/> </File>");

                    sw.WriteLine(@"<ProgId Id='DeliverySystem.tlog' Description='Telemetry Log'>
  <Extension Id='tlog' ContentType='application/tlog'>
     <Verb Id='open' Command='Open' TargetFile='" + mainexeid + @"' Argument='""%1""' />
  </Extension>
</ProgId>
<ProgId Id='DeliverySystem.dfbin' Description='Binary Log'>
  <Extension Id='dfbin' ContentType='application/dflog'>
     <Verb Id='open' Command='Open' TargetFile='" + mainexeid + @"' Argument='""%1""' />
  </Extension>
</ProgId>
<ProgId Id='DeliverySystem.log' Description='DF Log'>
  <Extension Id='log' ContentType='application/dflog'>
     <Verb Id='open' Command='Open' TargetFile='" + mainexeid + @"' Argument='""%1""' />
  </Extension>
</ProgId>
 <RegistryValue Root=""HKCR"" Key=""DeliverySystem.tlog\shellex\{BB2E617C-0920-11D1-9A0B-00C04FC2D6C1}"" Value=""{f3b857f1-0b79-4e77-9d0b-8b8b7e874f56}"" Type=""string"" Action=""write"" />
 <RegistryValue Root=""HKCR"" Key=""DeliverySystem.tlog\shellex\{e357fccd-a995-4576-b01f-234630154e96}"" Value=""{f3b857f1-0b79-4e77-9d0b-8b8b7e874f56}"" Type=""string"" Action=""write"" />

 <RegistryValue Root=""HKCR"" Key=""DeliverySystem.dfbin\shellex\{BB2E617C-0920-11D1-9A0B-00C04FC2D6C1}"" Value=""{f3b857f1-0b79-4e77-9d0b-8b8b7e874f56}"" Type=""string"" Action=""write"" />
 <RegistryValue Root=""HKCR"" Key=""DeliverySystem.dfbin\shellex\{e357fccd-a995-4576-b01f-234630154e96}"" Value=""{f3b857f1-0b79-4e77-9d0b-8b8b7e874f56}"" Type=""string"" Action=""write"" />

 <RegistryValue Root=""HKCR"" Key=""DeliverySystem.log\shellex\{BB2E617C-0920-11D1-9A0B-00C04FC2D6C1}"" Value=""{f3b857f1-0b79-4e77-9d0b-8b8b7e874f56}"" Type=""string"" Action=""write"" />
 <RegistryValue Root=""HKCR"" Key=""DeliverySystem.log\shellex\{e357fccd-a995-4576-b01f-234630154e96}"" Value=""{f3b857f1-0b79-4e77-9d0b-8b8b7e874f56}"" Type=""string"" Action=""write"" />
");
